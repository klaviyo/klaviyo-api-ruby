  ...
  class CustomMetricDefinition
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `KlaviyoAPI::CustomMetricDefinition` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KlaviyoAPI::CustomMetricDefinition`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @aggregation_method.nil?
        invalid_properties.push('invalid value for "aggregation_method", aggregation_method cannot be nil.')
      end

      if @metric_groups.nil?
        invalid_properties.push('invalid value for "metric_groups", metric_groups cannot be nil.')
      end
    ...
    def aggregation_method=(aggregation_method)
      validator = EnumAttributeValidator.new('String', ["count", "value"])
    ...
    def hash
      [aggregation_method, metric_groups].hash
    end
