...
```shell
gem install ./klaviyo-api-sdk-5.1.0.gem
```


Finally add this to the Gemfile:

    gem 'klaviyo-api-sdk', '~> 5.1.0'
...
_**NOTE:**_
- Organization: Resource groups and operation_ids are listed in alphabetical order, first by Resource name, then by **OpenAPI Summary**. Operation summaries are those listed in the right side bar of the [API Reference](https://developers.klaviyo.com/en/v2023-12-15/reference/get_events).
...
#### [Create Tag](https://developers.klaviyo.com/en/v2023-12-15/reference/create_tag)
...
#### [Create Tag Relationships Lists](https://developers.klaviyo.com/en/v2023-12-15/reference/create_tag_relationships_lists)
...
#### [Delete Tag Relationships Campaigns](https://developers.klaviyo.com/en/v2023-12-15/reference/delete_tag_relationships_campaigns)
