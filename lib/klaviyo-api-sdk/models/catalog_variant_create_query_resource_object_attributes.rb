...
module KlaviyoAPI
  class CatalogVariantCreateQueryResourceObjectAttributes
    ...
    def hash
      [sku, description, title, url, inventory_policy, price, custom_metadata, inventory_quantity, catalog_type, image_full_url, published, images, image_thumbnail_url, external_id, integration_type].hash
    end
