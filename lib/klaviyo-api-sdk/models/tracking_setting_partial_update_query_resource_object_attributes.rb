...
module KlaviyoAPI
  class TrackingSettingPartialUpdateQueryResourceObjectAttributes
    ...
    attr_accessor :auto_add_parameters
    ...
    def self.openapi_types
      {
        ...
        :'custom_parameters' => :'Array<CustomTrackingParamDTO>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `KlaviyoAPI::TrackingSettingPartialUpdateQueryResourceObjectAttributes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KlaviyoAPI::TrackingSettingPartialUpdateQueryResourceObjectAttributes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'auto_add_parameters')
        self.auto_add_parameters = attributes[:'auto_add_parameters']
      end
      ...
      if attributes.key?(:'custom_parameters')
        if (value = attributes[:'custom_parameters']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          auto_add_parameters == o.auto_add_parameters &&
    ...
    def hash
      [auto_add_parameters, utm_source, utm_medium, utm_campaign, utm_id, utm_term, custom_parameters].hash
    end
