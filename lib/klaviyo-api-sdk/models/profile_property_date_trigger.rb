...
module KlaviyoAPI
  class ProfilePropertyDateTrigger
    ...
    def hash
      [type, date_field_type, date_profile_property, timedelta_unit_before_date, timedelta_value_before_date, recurrence_frequency, timezone, trigger_time, trigger_days, internal_metric_id].hash
    end
