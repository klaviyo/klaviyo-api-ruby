...
module KlaviyoAPI
  class CampaignsApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :fields_campaign_message For more information please visit https://developers.klaviyo.com/en/v2024-06-15/reference/api-overview#sparse-fieldsets
    # @option opts [Array<String>] :fields_campaign For more information please visit https://developers.klaviyo.com/en/v2024-06-15/reference/api-overview#sparse-fieldsets
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :fields_campaign_recipient_estimation For more information please visit https://developers.klaviyo.com/en/v2024-06-15/reference/api-overview#sparse-fieldsets
    # @return [Hash<String, Object>]
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :fields_campaign_recipient_estimation_job For more information please visit https://developers.klaviyo.com/en/v2024-06-15/reference/api-overview#sparse-fieldsets
    # @return [Hash<String, Object>]
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :fields_campaign_send_job For more information please visit https://developers.klaviyo.com/en/v2024-06-15/reference/api-overview#sparse-fieldsets
    # @return [Hash<String, Object>]
