...
module KlaviyoAPI
  class TemplatesApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [Hash<String, Object>]
    def create_template_render(id, v2_template_render_query, opts = {})
      data, _status_code, _headers = create_template_render_with_http_info(id, v2_template_render_query, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Hash<String, Object>, Integer, Hash)>] Hash<String, Object> data, response status code and response headers
    def create_template_render_with_http_info(id, v2_template_render_query, opts = {})
      if @api_client.config.debugging
