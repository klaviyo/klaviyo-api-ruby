...
module KlaviyoAPI
  class EmailMarketing
    ...
    attr_accessor :list_suppressions
    ...
    def self.openapi_types
      {
        ...
        :'suppressions' => :'EmailMarketingSuppression',
        :'list_suppressions' => :'EmailMarketingListSuppression'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `KlaviyoAPI::EmailMarketing` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KlaviyoAPI::EmailMarketing`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'method_detail')
        self.method_detail = attributes[:'method_detail']
      end

      if attributes.key?(:'custom_method_detail')
        self.custom_method_detail = attributes[:'custom_method_detail']
      end
      ...
      if attributes.key?(:'list_suppressions')
        self.list_suppressions = attributes[:'list_suppressions']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          method == o.method &&
          method_detail == o.method_detail &&
          custom_method_detail == o.custom_method_detail &&
          double_optin == o.double_optin &&
          suppressions == o.suppressions &&
          list_suppressions == o.list_suppressions
    end
    ...
    def hash
      [consent, timestamp, method, method_detail, custom_method_detail, double_optin, suppressions, list_suppressions].hash
    end
