...
module KlaviyoAPI
  class TagsApi
    ...
    # @param id [String] The Tag ID
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :fields_tag_group For more information please visit https://developers.klaviyo.com/en/v2025-01-15/reference/api-overview#sparse-fieldsets
