...
module KlaviyoAPI
  class LowInventoryTrigger
    ...
    # @param [Object] product_level Object to be assigned
    def product_level=(product_level)
      validator = EnumAttributeValidator.new('String', ["product", "variant"])
      unless validator.valid?(product_level)
        fail ArgumentError, "invalid value for \"product_level\", must be one of #{validator.allowable_values}."
      end
      @product_level = product_level
    end
