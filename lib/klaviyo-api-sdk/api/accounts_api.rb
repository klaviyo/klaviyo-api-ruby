...
module KlaviyoAPI
  class AccountsApi
    ...
    # @option opts [Array<String>] :fields_account For more information please visit https://developers.klaviyo.com/en/v2023-07-15/reference/api-overview#sparse-fieldsets
