...
module KlaviyoAPI
  class CustomObjectDateTrigger
    ...
    attr_accessor :date_custom_object_label
    ...
    attr_accessor :internal_metric_id
    ...
    def self.openapi_types
      {
        :'type' => :'DateEnum',
        :'date_field_type' => :'CustomObjectEnum',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `KlaviyoAPI::CustomObjectDateTrigger` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KlaviyoAPI::CustomObjectDateTrigger`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'date_custom_object_label')
        self.date_custom_object_label = attributes[:'date_custom_object_label']
      end
      ...
      if attributes.key?(:'internal_metric_id')
        self.internal_metric_id = attributes[:'internal_metric_id']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @date_custom_object_label.nil?
        invalid_properties.push('invalid value for "date_custom_object_label", date_custom_object_label cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @date_custom_object_label.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          date_custom_object_label == o.date_custom_object_label &&
          ...
          internal_metric_id == o.internal_metric_id
    end
    ...
    def hash
      [type, date_field_type, date_custom_object_label, timedelta_unit_before_date, timedelta_value_before_date, recurrence_frequency, timezone, trigger_time, trigger_days, internal_metric_id].hash
    end
